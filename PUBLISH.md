...
**Sequence matters.** Complete steps 1–3 *before* approaching any national programme, health system,
funder, accelerator or potential collaborator.
...
Publish `CONCEPT_NOTE.md` and `OBLIGATION_SPEC.md` to **Zenodo** (https://zenodo.org) — operated by
CERN, free, permanent.

- Upload type: **Publication → Preprint** (or *Working paper*)
- Licence: **CC BY 4.0**
- Add your ORCID
...
**Why this name.** Arabic *أمانة* — a trust; something entrusted to your keeping that you are
...
- Use the spelling **Amanah** consistently — more distinctive than *Amana*, and closer to the
  Malay/Urdu form

**Do before any launch or funding round — trademark clearance:**
...
**Not novel — cite it, do not claim it:**
...
> A portable, patient-owned clinical obligation object — condition-agnostic, source-agnostic
...
allows a 12-month grace period). Given the stated goal — free for everyone — that is the intended
outcome, not a cost.
